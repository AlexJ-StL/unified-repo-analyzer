...
describe('CI Configuration', () => {
  ...
  describe('Async Operations', () => {
    it('should handle timeout operations', async () => {
      ...
      const result = await CIAsyncOperations.withTimeout(fastOperation, 1000, 'fast-op');
    ...
    it('should timeout slow operations', async () => {
      ...
      await expect(CIAsyncOperations.withTimeout(slowOperation, 50, 'slow-op')).rejects.toThrow(
    ...
    it('should retry failed operations', async () => {
      ...
      const result = await CIAsyncOperations.withRetry(flakyOperation, 5, 10, 'flaky-op');
      expect(result).toBe('success');
