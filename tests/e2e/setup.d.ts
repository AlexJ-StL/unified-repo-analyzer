 ...
 */
export declare function createTestRepository(name: string, files: Record<string, string>): Promise<TestRepository>;
/**
 * Wait for analysis to complete
 */
export declare function waitForAnalysis(baseUrl: string, analysisId: string, timeout?: number): Promise<any>;
/**
