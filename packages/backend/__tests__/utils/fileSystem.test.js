...
import { traverseDirectory, readFileWithErrorHandling, getCommonIgnorePatterns, readGitignore, getCombinedIgnorePatterns, extractDirectoryInfo, FileSystemError, FileSystemErrorType, } from '../../src/utils/fileSystem';
...
describe('File System Utilities', () => {
    ...
    beforeEach(async () => {
        ...
        await writeFile(path.join(testDir, 'src', 'utils', 'helpers.js'), 'export function helper() {}');
