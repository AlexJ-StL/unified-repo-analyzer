...
describe('ProviderRegistry', () => {
    ...
    describe('default provider', () => {
        ...
        test('should throw error when setting non-existent provider as default', () => {
            const registry = ProviderRegistry.getInstance();
            expect(() => registry.setDefaultProvider('non-existent')).toThrow("Provider 'non-existent' is not registered");
        });
    ...
    describe('provider management', () => {
        ...
        test('should throw error when creating non-existent provider', () => {
            const registry = ProviderRegistry.getInstance();
            expect(() => registry.createProvider('non-existent')).toThrow("Provider 'non-existent' is not registered");
        });
    });
    describe('reset', () => {
