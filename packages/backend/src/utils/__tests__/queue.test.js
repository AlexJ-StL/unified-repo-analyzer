...
describe('TaskQueue', () => {
    ...
    const mockProcessor = jest.fn().mockImplementation(async (data) => {
        return data * 2;
    });
    ...
    test('should handle task failures', async () => {
        ...
        const failingProcessor = jest.fn().mockImplementation(async (data) => {
            if (data % 2 === 0) {
    ...
    test('should handle task timeout', async () => {
        ...
        const slowProcessor = jest.fn().mockImplementation(async (data) => {
