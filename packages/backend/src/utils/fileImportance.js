 ...
 */
export function calculateFileImportance(filePath, fileSize, repoPath) {
    const factors = calculateImportanceFactors(filePath, fileSize, repoPath);
    // Combine factors with weights
    const weightedScore = factors.baseScore * 0.1 +
 ...
 */
export function calculateImportanceFactors(filePath, fileSize, repoPath) {
 ...
 */
export function sortFilesByImportance(files, repoPath, fileSizes) {
    return files
        .map((file) => {
...
//# sourceMappingURL=fileImportance.js.map