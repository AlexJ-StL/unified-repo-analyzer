...
export class ExportService {
   ...
   */
  public async exportAnalysis(analysis: RepositoryAnalysis, format: OutputFormat): Promise<string> {
    switch (format) {
      case 'json':
   ...
   * @returns Promise resolving to the exported content
   */
  public async exportBatchAnalysis(
   ...
   */
  public async saveToFile(content: string, outputPath: string): Promise<string> {
   ...
   * @returns JSON string
   */
  private exportToJson(analysis: RepositoryAnalysis): string {
   ...
   */
  private exportToMarkdown(analysis: RepositoryAnalysis): string {
...
`;
   ...
   * @returns HTML string
   */
  private exportToHtml(analysis: RepositoryAnalysis): string {
...
<body>
   ...
   * @returns JSON string
   */
  private exportBatchToJson(batchResult: BatchAnalysisResult): string {
   ...
   * @returns Markdown string
   */
  private exportBatchToMarkdown(batchResult: BatchAnalysisResult): string {
...
`;
   ...
   * @returns HTML string
   */
  private exportBatchToHtml(batchResult: BatchAnalysisResult): string {
    const repositories = batchResult.repositories;
