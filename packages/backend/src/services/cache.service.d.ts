import { AnalysisOptions, RepositoryAnalysis, BatchAnalysisResult } from '@unified-repo-analyzer/shared/src/types/analysis';
...
export declare class EnhancedCacheService extends CacheService<any> {
     ...
     */
    setCachedAnalysis(repoPath: string, options: AnalysisOptions, analysis: RepositoryAnalysis, ttl?: number): Promise<void>;
    /**
     ...
     */
    setCachedBatchAnalysis(repoPaths: string[], options: AnalysisOptions, batchResult: BatchAnalysisResult, ttl?: number): Promise<void>;
    /**
     * Get cached batch analysis result
     */
    getCachedBatchAnalysis(repoPaths: string[], options: AnalysisOptions): Promise<BatchAnalysisResult | null>;
    /**
