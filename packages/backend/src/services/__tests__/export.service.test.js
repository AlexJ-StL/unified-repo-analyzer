...
└── package.json`,
    ...
    insights: {
        ...
        technicalBreakdown: 'The codebase follows modern TypeScript practices with good separation of concerns.',
...
describe('ExportService', () => {
    ...
    describe('exportAnalysis', () => {
        ...
        it('throws error for unsupported format', async () => {
            await expect(exportService.exportAnalysis(mockAnalysis, 'xml')).rejects.toThrow('Unsupported export format: xml');
        });
    });
    describe('exportBatchAnalysis', () => {
        ...
        it('throws error for unsupported format', async () => {
            await expect(exportService.exportBatchAnalysis(mockBatchAnalysis, 'pdf')).rejects.toThrow('Unsupported export format: pdf');
        });
    });
