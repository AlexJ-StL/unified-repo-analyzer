 ...
 */
import { UserPreferences, WorkspaceConfiguration, ProjectConfiguration, ConfigurationProfile, ConfigurationValidationResult, ConfigurationBackup, AnalysisModePreset } from '@unified-repo-analyzer/shared';
export declare class ConfigurationService {
     ...
     */
    saveWorkspaceConfiguration(workspace: Omit<WorkspaceConfiguration, 'id' | 'createdAt' | 'updatedAt'>): Promise<WorkspaceConfiguration>;
    /**
     * Update workspace configuration
     */
    updateWorkspaceConfiguration(id: string, updates: Partial<WorkspaceConfiguration>): Promise<WorkspaceConfiguration>;
    /**
     ...
     */
    saveProjectConfiguration(project: Omit<ProjectConfiguration, 'id' | 'createdAt' | 'updatedAt'>): Promise<ProjectConfiguration>;
    /**
     * Update project configuration
     */
    updateProjectConfiguration(id: string, updates: Partial<ProjectConfiguration>): Promise<ProjectConfiguration>;
    /**
     ...
     */
    saveConfigurationProfile(profile: Omit<ConfigurationProfile, 'id' | 'createdAt' | 'updatedAt'>): Promise<ConfigurationProfile>;
    /**
