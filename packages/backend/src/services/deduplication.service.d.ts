...
export declare class DeduplicationService {
     ...
     */
    deduplicateAnalysis<T>(repoPath: string, options: AnalysisOptions, executor: () => Promise<T>): Promise<T>;
    /**
     * Deduplicates batch analysis requests
     */
    deduplicateBatch<T>(repoPaths: string[], options: AnalysisOptions, executor: () => Promise<T>): Promise<T>;
    /**
