...
describe('API Integration Tests', () => {
  beforeEach(() => {
    ...
    vi.mocked(AnalysisEngine.prototype.analyzeRepository).mockResolvedValue({
      id: '123',
      path: '/test/repo',
      name: 'test-repo',
      language: 'JavaScript',
    ...
    vi.mocked(AnalysisEngine.prototype.analyzeMultipleRepositories).mockResolvedValue(undefined);
    vi.mocked(AnalysisEngine.prototype.analyzeMultipleRepositoriesWithQueue).mockResolvedValue(
      undefined
    );
    vi.mocked(AnalysisEngine.prototype.generateSynopsis).mockResolvedValue('');
    vi.mocked(AnalysisEngine.prototype.updateIndex).mockResolvedValue(undefined);
    vi.mocked(AnalysisEngine.prototype.searchRepositories).mockResolvedValue([]);
    vi.mocked(AnalysisEngine.prototype.findSimilarRepositories).mockResolvedValue([]);
    vi.mocked(AnalysisEngine.prototype.suggestCombinations).mockResolvedValue([]);

    // Mock IndexSystem prototype methods
    vi.mocked(IndexSystem.prototype.addRepository).mockResolvedValue(undefined);
    ...
    vi.mocked(IndexSystem.prototype.searchRepositories).mockResolvedValue([]);
    vi.mocked(IndexSystem.prototype.findSimilarRepositories).mockResolvedValue([]);
  });
