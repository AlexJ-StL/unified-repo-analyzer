...
describe('Analysis Engine', () => {
    ...
    describe('analyzeMultipleRepositories', () => {
        test('should analyze multiple repositories', async () => {
            ...
            const result = await engine.analyzeMultipleRepositories(['/test/repo1', '/test/repo2'], options);
            expect(result).toBeDefined();
        ...
        test('should handle errors in individual repositories', async () => {
            const { discoverRepository: mockDiscoverRepository } = await import('../../utils/repositoryDiscovery');
    ...
    describe('generateSynopsis', () => {
        ...
        test('should throw error for unsupported format', async () => {
            ...
            await expect(engine.generateSynopsis(analysis, 'pdf')).rejects.toThrow('Unsupported output format: pdf');
        });
    });
});
