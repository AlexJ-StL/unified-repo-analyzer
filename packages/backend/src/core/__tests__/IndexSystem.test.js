...
describe('IndexSystem', () => {
    ...
    const createMockAnalysis = (name, languages = ['JavaScript'], frameworks = ['React']) => {
        return {
            id: uuidv4(),
            path: `/path/to/${name}`,
            name,
    ...
    describe('searchRepositories', () => {
        beforeEach(async () => {
            ...
            await indexSystem.addRepository(createMockAnalysis('react-app', ['JavaScript', 'TypeScript'], ['React', 'Redux']));
            await indexSystem.addRepository(createMockAnalysis('vue-app', ['JavaScript'], ['Vue']));
            await indexSystem.addRepository(createMockAnalysis('express-api', ['JavaScript', 'TypeScript'], ['Express', 'Node.js']));
    ...
    describe('findSimilarRepositories', () => {
        ...
        beforeEach(async () => {
            // Add sample repositories
            const repo1 = createMockAnalysis('react-app', ['JavaScript', 'TypeScript'], ['React', 'Redux']);
            const repo2 = createMockAnalysis('react-native-app', ['JavaScript', 'TypeScript'], ['React', 'React Native']);
            const repo3 = createMockAnalysis('vue-app', ['JavaScript'], ['Vue']);
            const repo4 = createMockAnalysis('express-api', ['JavaScript', 'TypeScript'], ['Express', 'Node.js']);
    ...
    describe('suggestCombinations', () => {
        ...
        beforeEach(async () => {
            // Add sample repositories
            const repo1 = createMockAnalysis('react-app', ['JavaScript', 'TypeScript'], ['React', 'Redux']);
            const repo2 = createMockAnalysis('express-api', ['JavaScript', 'TypeScript'], ['Express', 'Node.js']);
            const repo3 = createMockAnalysis('vue-app', ['JavaScript'], ['Vue']);
...
//# sourceMappingURL=IndexSystem.test.js.map