 ...
 */
import { AnalysisOptions, RepositoryAnalysis, BatchAnalysisResult, OutputFormat, SearchQuery, SearchResult } from '@unified-repo-analyzer/shared/src/types/analysis';
...
export declare class AnalysisEngine {
     ...
     */
    analyzeMultipleRepositories(repoPaths: string[], options: AnalysisOptions): Promise<BatchAnalysisResult>;
    /**
     ...
     * @returns Promise resolving to batch analysis result
     */
    analyzeMultipleRepositoriesWithQueue(repoPaths: string[], options: AnalysisOptions, concurrency?: number, progressCallback?: (progress: any) => void): Promise<BatchAnalysisResult>;
    /**
