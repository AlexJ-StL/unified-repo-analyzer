...
export const dependencySchema = z.object({
  ...
  type: z.enum(['development', 'production', 'peer', 'optional'] as const).default('production'),
...
export const analysisOptionsSchema = z.object({
  mode: z.enum(['quick', 'standard', 'comprehensive'] as const).default('standard'),
...
export const complexityMetricsSchema = z.object({
  ...
  codeQuality: z.enum(['excellent', 'good', 'fair', 'poor'] as const).default('good'),
...
export const llmResponseSchema = z.object({
  ...
  finishReason: z.enum(['stop', 'length', 'content_filter', 'tool_calls'] as const).optional(),
...
export const analysisPreferencesSchema = z.object({
  defaultMode: z.enum(['quick', 'standard', 'comprehensive'] as const).default('standard'),
...
export const exportPreferencesSchema = z.object({
  defaultFormat: z.enum(['json', 'markdown', 'html', 'csv', 'xml'] as const).default('json'),
