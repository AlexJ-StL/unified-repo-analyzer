...
export const functionInfoSchema = z.object({
  ...
  parameters: z
    .array(z.string())
    .max(100, "Too many parameters (max 100)")
    .default([]),
...
export const classInfoSchema = z.object({
  ...
  methods: z
    .array(z.string())
    .max(1000, "Too many methods (max 1000)")
    .default([]),
  ...
  extends: z
    .string()
    .max(stringConstraints.maxNameLength, "Parent class name too long")
    .optional(),

  implements: z
    .array(z.string())
    .max(50, "Too many interfaces (max 50)")
    .default([]),
...
export const fileInfoSchema = z.object({
  path: z
    ...
    .refine(
      (path) =>
        commonPatterns.absolutePath.test(path) ||
        commonPatterns.relativePath.test(path),
  ...
  tokenCount: z
    ...
    .max(
      numericConstraints.maxTokens,
      `Token count exceeds ${numericConstraints.maxTokens} limit`
    )
    .optional(),
  ...
  functions: z
    .array(functionInfoSchema)
    .max(1000, "Too many functions (max 1000)")
    .default([]),

  classes: z
    .array(classInfoSchema)
    .max(500, "Too many classes (max 500)")
    .default([]),
...
export const dependencySchema = z.object({
  ...
  type: z
    .enum(["development", "production", "peer", "optional"] as const)
    .default("production"),
...
export const frameworkSchema = z.object({
  name: z
    .string()
    .min(1, "Framework name cannot be empty")
    .max(100, "Framework name too long"),
...
export const analysisOptionsSchema = z.object({
  mode: z
    .enum(["quick", "standard", "comprehensive"] as const)
    .default("standard"),
  ...
  outputFormats: z
    .array(z.enum(["json", "markdown", "html", "csv", "xml"] as const))
...
export const complexityMetricsSchema = z.object({
  ...
  technicalDebt: z
    .string()
    .max(100, "Technical debt description too long")
    .default("none"),
...
export const architecturalPatternSchema = z.object({
  ...
  examples: z
    .array(z.string())
    .max(50, "Too many examples (max 50)")
    .default([]),
});
...
export const llmRequestSchema = z.object({
  ...
  maxTokens: z
    ...
    .max(
      numericConstraints.maxTokens,
      `Max tokens exceeds ${numericConstraints.maxTokens} limit`
    )
    .default(1000),
...
export const llmResponseSchema = z.object({
  ...
  finishReason: z
    .enum(["stop", "length", "content_filter", "tool_calls"] as const)
    .optional(),
...
export const fileAnalysisSchema = z.object({
  ...
  comments: z
    .array(z.string())
    .max(1000, "Too many comments (max 1000)")
    .default([]),
  ...
  sample: z
    .string()
    .max(5000, "Sample code too long (max 5000 characters)")
    .optional(),
  ...
  dependencies: z
    ...
    .max(100, "Too many dependencies (max 100)")
    .default([]),

  frameworks: z
    .array(frameworkSchema)
    .max(50, "Too many frameworks (max 50)")
    .default([]),
});
...
export const projectInfoSchema = z.object({
  ...
  directories: z
    .array(z.string())
    .max(10000, "Too many directories (max 10000)")
    .default([]),

  keyFiles: z
    .array(z.string())
    .max(1000, "Too many key files (max 1000)")
    .default([]),
  ...
  frameworks: z
    .array(frameworkSchema)
    .max(100, "Too many frameworks (max 100)")
    .default([]),
...
export const exportPreferencesSchema = z.object({
  defaultFormat: z
    .enum(["json", "markdown", "html", "csv", "xml"] as const)
    .default("json"),
  ...
  dateFormat: z
    .string()
    .max(50, "Date format string too long")
...
export const repositoryAnalysisSchema = z.object({
  ...
  path: z
    ...
    .max(4096, "Repository path too long"),
  language: z.string().max(50, "Language name too long").nullable().optional(),
  languages: z
    .array(z.string())
    .max(50, "Too many languages (max 50)")
...
export const searchQuerySchema = z.object({
  ...
  limit: z
    ...
    .int()
    .positive()
    .max(1000, "Limit exceeds maximum")
    .default(50),
...
export const providerConfigSchema = z.object({
  ...
  maxTokens: z
    ...
    .int()
    .positive()
    .max(100000, "Max tokens exceeds limit")
    .default(1000),
