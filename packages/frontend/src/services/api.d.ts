...
export declare const apiService: {
    analyzeRepository: (path: string, options: any) => Promise<import("axios").AxiosResponse<any, any>>;
    ...
    searchRepositories: (query: string, filters: any) => Promise<import("axios").AxiosResponse<any, any>>;
    getAnalysis: (id: string) => Promise<import("axios").AxiosResponse<any, any>>;
    exportAnalysis: (analysis: any, format: string, download?: boolean) => Promise<import("axios").AxiosResponse<any, any>>;
    exportBatchAnalysis: (batchAnalysis: any, format: string, download?: boolean) => Promise<import("axios").AxiosResponse<any, any>>;
