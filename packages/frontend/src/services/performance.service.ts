...
export class PerformanceService {
  ...
  private handleNavigationEntry(entry: PerformanceNavigationTiming): void {
    ...
    this.recordMetric('navigation.domInteractive', entry.domInteractive - navigationStart);
    this.recordMetric('navigation.domComplete', entry.domComplete - navigationStart);
  }
  ...
  public getStats(): {
    ...
    const interactionMetrics = this.metrics.filter(
      (m) => m.tags?.type === 'user-interaction' || m.tags?.type === 'component-render'
    );
