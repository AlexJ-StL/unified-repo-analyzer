  ...
  const loadRelationshipData = async () => {
    try {
      ...
      const [graphResponse, insightsResponse, opportunitiesResponse] = await Promise.all([
        apiService.get('/api/repositories/relationships/graph', {
          params: { repositoryIds: selectedRepositories },
        }),
        apiService.get('/api/repositories/relationships/insights', {
          params: { repositoryIds: selectedRepositories },
        }),
        apiService.post('/api/repositories/relationships/opportunities', {
