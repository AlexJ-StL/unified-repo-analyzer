...
import api, { apiService, handleApiError } from "../services/api";

const RelationshipsPage: React.FC = () => {
	const [searchParams, setSearchParams] = useSearchParams();
	const [activeTab, setActiveTab] = useState<
		"graph" | "insights" | "opportunities"
	>("graph");
	const [selectedRepositories, setSelectedRepositories] = useState<string[]>(
		[],
	);
	const [relationshipGraph, setRelationshipGraph] =
		useState<RelationshipGraph | null>(null);
	const [relationshipInsights, setRelationshipInsights] =
		useState<RelationshipInsights | null>(null);
	...
	const loadRelationshipData = async () => {
		try {
			...
			const [graphResponse, insightsResponse, opportunitiesResponse] =
				await Promise.all([
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
					<div className="text-center">
						...
						<p className="mt-1 text-sm text-gray-500">
							Select repositories from the repositories page to analyze their
							relationships and integration opportunities.
						</p>
						<div className="mt-6">
							<a
								href="/repositories"
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
				...
				<div className="mb-8">
					...
					<p className="mt-2 text-gray-600">
						Analyze relationships, discover integration opportunities, and
					...
					<>
						{activeTab === "graph" && relationshipGraph && (
							<div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
								...
								<p className="text-gray-600 mb-6">
									...
									repositories. Click and drag nodes to explore connections.
								</p>
						...
						{activeTab === "insights" && relationshipInsights && (
							<div>
								...
								<p className="text-gray-600 mb-6">
									Statistical analysis and insights about repository
									relationships, technologies, and patterns.
								</p>
						...
						{activeTab === "opportunities" && (
							<div>
								...
								<p className="text-gray-600 mb-6">
									Discover potential ways to integrate your repositories into
