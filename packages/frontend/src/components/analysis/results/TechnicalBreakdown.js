...
const TechnicalBreakdown = ({ analysis }) => {
    ...
    return (<div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-gray-50 p-4 rounded-md">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between">
              ...
              <span className={`font-medium ${getQualityColor(codeAnalysis.complexity.codeQuality)}`}>
        ...
        <div className="bg-gray-50 p-4 rounded-md">
          ...
          {codeAnalysis.patterns && codeAnalysis.patterns.length > 0 ? (<div className="space-y-4">
              {codeAnalysis.patterns.map((pattern, index) => (<div key={index} className="border-b border-gray-200 pb-3 last:border-b-0 last:pb-0">
            ...
            </div>) : (<p className="text-gray-500">No architectural patterns detected.</p>)}
        </div>
      </div>
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {structure.keyFiles.slice(0, 10).map((file, index) => (<tr key={index}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    <div className="flex items-center">
                      <div className="w-16 bg-gray-200 rounded-full h-2.5">
                        <div className="bg-blue-600 h-2.5 rounded-full" style={{ width: `${file.importance * 100}%` }}></div>
                      </div>
...
//# sourceMappingURL=TechnicalBreakdown.js.map