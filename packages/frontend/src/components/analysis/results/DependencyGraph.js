...
const DependencyGraph = ({ analysis }) => {
    ...
    const hasDependencies = analysis.dependencies.production.length > 0 ||
        analysis.dependencies.development.length > 0 ||
        analysis.dependencies.frameworks.length > 0;
    if (!hasDependencies) {
        return (<div className="text-center py-10">
        <p className="text-gray-500">No dependencies found for this repository.</p>
      </div>);
    }
    return (<div className="space-y-4">
      <div className="flex justify-between items-center">
        <h3 className="text-lg font-semibold text-gray-800">Dependency Graph</h3>
