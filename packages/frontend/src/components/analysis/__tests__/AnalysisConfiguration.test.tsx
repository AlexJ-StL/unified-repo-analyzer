...
describe("AnalysisConfiguration", () => {
  ...
  it("updates options when output formats are changed", () => {
    ...
    const htmlCheckbox = screen.getByText(/HTML/i)
  ...
  it("updates options when number inputs change", () => {
    ...
    fireEvent.change(screen.getByLabelText(/Max Files to Process/i), {
      target: { value: "200" },
    });
    ...
    fireEvent.change(screen.getByLabelText(/Max Lines Per File/i), {
      target: { value: "2000" },
    });
