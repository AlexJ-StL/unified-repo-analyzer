...
describe('AnalysisConfiguration Error Handling', () => {
    ...
    it('handles component errors with error boundary', () => {
        ...
        expect(screen.getByText(/The analysis configuration component encountered an error/)).toBeInTheDocument();
...
//# sourceMappingURL=AnalysisConfiguration.error.test.js.map