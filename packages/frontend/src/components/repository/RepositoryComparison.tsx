...
interface ComparisonResult {
  ...
  differences: {
    languages: { [repoId: string]: string[] };
    frameworks: { [repoId: string]: string[] };
    dependencies: { [repoId: string]: string[] };
    size: { [repoId: string]: number };
    complexity: { [repoId: string]: number };
  };
                  ...
                  <div className="flex-1">
                    <div className="w-full bg-gray-200 rounded-full h-2.5">
                      <div
                        ...
                        style={{ width: `${comparison.integrationPotential.score * 10}%` }}
                      ></div>
                    </div>
                  </div>
                </div>
