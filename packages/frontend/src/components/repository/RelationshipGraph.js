...
const RelationshipGraphComponent = ({ data, width = 800, height = 600, onNodeClick, onEdgeClick, }) => {
    ...
    useEffect(() => {
        ...
        node
            ...
            link.attr('stroke-opacity', (edge) => edge.source === d.id || edge.target === d.id ? 1 : 0.2);
            // Show tooltip
            const tooltip = d3
                .select('body')
                .append('div')
    ...
    return (<div className="relationship-graph">
      <svg ref={svgRef} width={width} height={height} style={{ border: '1px solid #e2e8f0', borderRadius: '8px' }}/>
      ...
      <div className="mt-4 flex flex-wrap gap-4 text-sm">
        <div className="flex items-center gap-2">
          ...
          {Object.entries({
            ...
            tool: '#9f7aea',
            application: '#4fd1c7',
        }).map(([type, color]) => (<div key={type} className="flex items-center gap-1">
