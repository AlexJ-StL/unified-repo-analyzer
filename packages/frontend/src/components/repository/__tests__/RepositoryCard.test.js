...
describe('RepositoryCard', () => {
    ...
    it('renders repository information correctly', () => {
        ...
        render(<RepositoryCard repository={mockRepository} isSelected={false} onSelect={onSelectMock} onView={onViewMock}/>);
    ...
    it('displays selected state correctly', () => {
        const onSelectMock = vi.fn();
        const onViewMock = vi.fn();
        render(<RepositoryCard repository={mockRepository} isSelected={true} onSelect={onSelectMock} onView={onViewMock}/>);
    ...
    it('formats different sizes correctly', () => {
        ...
        testSizes.forEach(({ size, expected }) => {
            const { unmount } = render(<RepositoryCard repository={{ ...mockRepository, size }} isSelected={false} onSelect={onSelectMock} onView={onViewMock}/>);
            expect(screen.getByText(expected)).toBeInTheDocument();
            unmount();
        });
    });
});
//# sourceMappingURL=RepositoryCard.test.js.map