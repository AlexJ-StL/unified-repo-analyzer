	...
	return (
		<div className="space-y-6">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
				...
				<div>
					...
					<select
						...
						onChange={(e) =>
							handleUpdate({ itemsPerPage: parseInt(e.target.value) })
						}
						className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
					>
			...
			<div className="space-y-4">
				...
				<div className="flex items-center">
					<input
						...
						onChange={(e) =>
							handleUpdate({ showAdvancedOptions: e.target.checked })
						}
						className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
					/>
					<label
				...
				<div className="flex items-center">
					<input
						...
						onChange={(e) =>
							handleUpdate({ enableAnimations: e.target.checked })
						}
						className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
					/>
					<label
			...
			<div className="border border-gray-300 dark:border-gray-600 rounded-lg p-4">
				...
				<div
					className={`space-y-2 ${preferences.ui.compactMode ? "space-y-1" : "space-y-2"}`}
				>
					<div
