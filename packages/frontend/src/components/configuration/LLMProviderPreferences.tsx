...
import { ProviderConfiguration } from '@unified-repo-analyzer/shared';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateProvider(providerId, { maxTokens: parseInt(e.target.value) })
                  }
                  min="1000"
                  max="100000"
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateProvider(providerId, { temperature: parseFloat(e.target.value) })
                  }
                  min="0"
                  max="1"
                  step="0.1"
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  onChange={(e) => updateProvider(providerId, { customEndpoint: e.target.value })}
