			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
				<div>
					...
					<input
						...
						onChange={(e) =>
							handleUpdate({ maxFiles: parseInt(e.target.value) })
						}
						min="1"
						max="10000"
				...
				<div>
					...
					<input
						...
						onChange={(e) =>
							handleUpdate({ maxLinesPerFile: parseInt(e.target.value) })
						}
						min="100"
						max="50000"
						className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
				...
				<div>
					...
					<input
						...
						onChange={(e) =>
							handleUpdate({ cacheTTL: parseInt(e.target.value) })
						}
						min="1"
						max="168"
						className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
			...
			<div className="space-y-4">
				<div className="flex items-center">
					<input
						...
						onChange={(e) =>
							handleUpdate({ includeLLMAnalysis: e.target.checked })
						}
