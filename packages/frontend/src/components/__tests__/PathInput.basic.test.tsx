...
import { cleanupMocks, mockFunction, setupMocks } from '../../../../../tests/MockManager';
...
describe('PathInput Basic Tests', () => {
  ...
  it('should show required indicator when required', () => {
    render(<PathInput label="Required Path" value="" onChange={mockOnChange} required={true} />);

    expect(screen.getByText('*')).toBeInTheDocument();
  });

  it('should display the current value', () => {
    render(<PathInput label="Test Path" value="C:\\test\\path" onChange={mockOnChange} />);
  ...
  it('should show format help button when showFormatHints is true', () => {
    render(<PathInput label="Test Path" value="" onChange={mockOnChange} showFormatHints={true} />);
  ...
  it('should show validate button when validateOnChange is false', () => {
    render(
      <PathInput label="Test Path" value="" onChange={mockOnChange} validateOnChange={false} />
    );
  ...
  it('should have proper accessibility attributes', () => {
    render(<PathInput label="Repository Path" value="" onChange={mockOnChange} required={true} />);
