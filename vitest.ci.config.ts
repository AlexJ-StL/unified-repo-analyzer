 ...
 *
 * This configuration resolves multi-reporter parsing conflicts in VS Code by providing
 * a unified, environment-aware reporter configuration that works across all projects.
 *
 * Features:
 * - Environment-aware reporter selection (CI vs local development)
 * - Unified configuration to prevent parsing conflicts
 * - Optimized for both CI pipelines and local development
 * - Maintains compatibility with existing project configurations
 */
