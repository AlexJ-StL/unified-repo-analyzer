...
export default mergeConfig(
  ...
  defineConfig({
    test: {
      ...
      // clearScreen: false, // Property 'clearScreen' does not exist on type 'InlineConfig'
      ...
      onConsoleLog: (log, type) => {
        ...
        if (type === 'stderr' || log.includes('ERROR') || log.includes('FAIL')) {
          return true;
        }
      ...
      restoreMocks: true,
      clearMocks: true,
      // resetMocks: true, // Property 'resetMocks' does not exist on type 'InlineConfig'
      unstubEnvs: true,
      unstubGlobals: true,
    },
  })
