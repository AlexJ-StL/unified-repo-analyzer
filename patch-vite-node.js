...
const importLineIndex = importLines.findIndex(line => line.includes('import { createRequire } from \'node:module\';'));
...
if (importLineIndex !== -1) {
  ...
  console.error('Could not find the import lines to patch in vite-node client');
  process.exit(1);
}